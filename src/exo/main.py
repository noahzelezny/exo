...
class Args(FrozenModel):
    ...
    # Comma-separated bind hosts for the HTTP API. Default matches upstream
    # (all interfaces). Scout launches pass loopback + the TB4 bridge IP so
    # the unauthenticated control API is not reachable from the home LAN
    # (2026-08-03 audit: 192.168.1.x could hit /state on both nodes).
